<?php
$apply_info = rbac_get_apply_info();
?>
...
<table class="table table-striped" id="apply_manage_table">
    ...
    <tbody>
    <?php for ($i = 0; $i < sizeof($apply_info); $i++) {?>
    <tr>
        <td id="uid" style="display: none"><?=$apply_info[$i]['user_id']?></td>
        <td id="stype" style="display: none"><?=$apply_info[$i]['source_type']?></td>
        <td id="sid" style="display: none"><?=$apply_info[$i]['source_id']?></td>
        <td><?=$apply_info[$i]['applyer']?></td>
        <td><?=$apply_info[$i]['item_name']?></td>
        <td><?=$apply_info[$i]['item_type']?></td>
        <td><?=$apply_info[$i]['reason']?></td>
        <td><?=$apply_info[$i]['modified_time']?></td>
    </tr>
    <? } ?>
    </tbody>
</table>
