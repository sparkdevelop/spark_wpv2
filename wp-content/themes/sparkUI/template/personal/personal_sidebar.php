...
<div class="col-md-3 col-sm-3 col-xs-3 right" id="col3">
    <div id="user-profile">
        ...
        <p style="margin-top: 10px;color: gray;width: 100%;overflow:hidden;white-space: nowrap;text-overflow: ellipsis;"><?php echo $user_description;?></p>
        <p style="color: gray">ID: <?php echo get_current_user_id();?></p>
    </div>
    <ul id="personal_nav" class="nav nav-pills nav-stacked">
        ...
        <li id="group">
            ...
            <span><a href="<?php echo esc_url(add_query_arg(array('tab'=>'group'),remove_query_arg(array('paged','filter'))))?>">我的群组</a></span>
        </li>
        <li id="favorite">
