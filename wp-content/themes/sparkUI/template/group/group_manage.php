...
<div>
    ...
    <ul id="groupManageTab" class="nav nav-tabs">
        <li><a href="#group_form" data-toggle="tab">群组设置</a></li>
        <li class="active"><a href="#member_verify" data-toggle="tab">成员审核</a></li>
    ...
    <div id="groupManageTabContent" class="tab-content">
        ...
        <div class="tab-pane fade in active" id="member_verify">
