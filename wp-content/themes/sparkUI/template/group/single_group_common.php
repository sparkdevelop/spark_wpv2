    ...
    <div id="single-group-title">
        ...
        <div id="group-info" >
            <div class="group_title">
                ...
                <span id="group-info-status" style="color: #fe642d;margin-left: 10px">已加入群组&nbsp;&nbsp;</span><button id="group_join_btn" onclick="quit_the_group(<?=$group['ID']?>,'<?=$admin_url?>')">退出</button><button id="m-group_join_btn" onclick="quit_the_group(<?=$group['ID']?>,'<?=$admin_url?>')">退出</button>
            </div>
