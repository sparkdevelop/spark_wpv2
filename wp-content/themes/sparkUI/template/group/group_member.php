    ...
    <div id="ml_admin">
        ...
        <?php for ($j = 0; $j < sizeof($admin_list); $j++) { ?>
            <div id="ml_avatar" style="display: inline-block;margin-top: 10px">
                ...
                <h5 style="width: 48px;word-wrap: break-word"><?php echo mb_strimwidth(get_user_by('ID',$admin_list[$j]['user_id'])->display_name, 0, 7,"..") ?></h5>
            </div>
        <?php } ?>
    </div>
    <div id="ml_member">
        ...
        <?php for ($j = 0; $j < sizeof($common_list); $j++) { ?>
            <div id="ml_avatar" style="display: inline-block;margin-top: 10px">
                ...
                <h5 style="width: 48px;word-wrap: break-word"><?php echo get_user_by('ID',$common_list[$j]['user_id'])->display_name ?></h5>
            </div>
        <?php } ?>
    </div>
</div>
