...
$verify_type = get_verify_type($_GET['group_id']);
    ...
    <div id="col9">
        ...
        <form class="form-horizontal" role="form" name="profile" method="post" enctype="multipart/form-data"
            ...
            for ($i = 0; $i < sizeof($verify_field); $i++) {
                ...
                <div class="form-group" style="margin: 20px 0px">
                    <label class="col-sm-2 col-md-2 col-xs-12 control-label"
                           style="float: left"><?= $verify_field[$i] ?>
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="verify_type" value="verifyjoin">
            </div>
            <div class="form-group">
...
<?php } else { ?>
    <div id="col9">
        <h4 class="ask_topic">请填写验证信息,以便管理员审核</h4>
        <form class="form-horizontal" role="form" name="profile" method="post" enctype="multipart/form-data"
              action="<?php echo esc_url(self_admin_url('process-verify.php')); ?>">
            <div class="form-group" style="margin: 20px 0px">
                <label class="col-sm-2 col-md-2 col-xs-12 control-label" style="float: left">验证信息
                    <span style="color: red">*</span></label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="verify_info" id="verify_info" value=""/>
                </div>
            </div>
            <!--        隐藏信息-->
            <div class="form-group">
                ...
                <input type="hidden" name="group_id" value="<?= $_GET['group_id'] ?>">
                <input type="hidden" name="apply_time" value="<?= date("Y-m-d H:i:s", time() + 8 * 3600) ?>">
                <input type="hidden" name="verify_type" value="verify">
            </div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <input type="submit" class="btn btn-default" name="save-btn" id="save-btn" value="提交">
