...
<script>
    function checkPassword(password) {
            ...
            xmlhttp.open("post","<?php echo esc_url( self_admin_url('profile-process.php') )?>?password="+password,true);
            xmlhttp.send();
        }
    ...
    function checkSubmit() {
        ...
        if(checkemail(email.value)&&checkNewPassword(newPassword.value)
        &&checkRepeatPassword(repectPassword.value)){
            return true;
        }else{
            alert ("请修正错误");
            return false;
    ...
    <form class="form-horizontal" role="form" name="profile" method="post" action="<?php echo esc_url( self_admin_url('profile-process.php') ); ?>" onsubmit="return checkSubmit();">
<!--        电子邮件-->
