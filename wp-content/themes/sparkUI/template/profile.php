...
$Sno = hasSinfo('Sno') ? get_user_meta($current_user->ID, 'Sno', true) : '';
$University = hasSinfo('University') ? get_user_meta($current_user->ID, 'University', true):'';
...
<form class="form-horizontal" role="form" name="profile"
    ...
    <!--        学校-->
    <div class="form-group" style="margin: 20px 0px">
        <label for="school_select" class="col-sm-2 col-md-2 col-xs-12 control-label" style="float: left">学校</label>
        <div class="col-sm-6">
            ...
            <script>
                if ('<?=$University?>'!=''){
                    $('#school_select').find('option[value="<?=$University?>"]').attr('selected','selected')
                }
            </script>
        </div>
    </div>
    ...
    <!--        学号-->
    <div class="form-group" style="margin: 20px 0px">
        <label for="Sno" class="col-sm-2 col-md-2 col-xs-12 control-label" style="float: left">学号</label>
        <div class="col-sm-6">
...
<form class="form-horizontal" role="form" name="password"
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <input type="submit" class="btn btn-default" id="save-password-btn" value="保存修改">
        </div>
    </div>
</form>
