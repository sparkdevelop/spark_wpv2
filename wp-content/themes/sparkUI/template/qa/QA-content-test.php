...
<!--            $page=$page+1;-->
<!--            location.href="test.php?paged="+$page;-->
<!--            window.location.reload();-->
<!--        }-->
<!--        function turn_last_page($page) {-->
<!--            $page=$page+1;-->
<!--           // window.location.reload();-->
<!--            //return $page;-->
<!--        }-->
...
//    }
    ...
    $hardware_last_page = $hardware_count/$per_page_num+1;
    $web_last_page = $web_count/$per_page_num+1;
    ?>
    <?php
