            ...
            <div class="sidebar-grey-frame" style="margin-top: 30px">
                <p>发布者：
                    <a href="<?php echo site_url() . get_page_address('otherpersonal') . '&id=' . get_post()->post_author . '&tab=project' ?>"
                       class="author_link" style="color: #5e5e5e;margin-right: 0"><?php echo get_the_author(); ?>
                        <?php
                    ...
                    <a href="<?php echo site_url() . get_page_address('info') . '&tab=integral' ?>"><img
                                src="<?php bloginfo("template_url") ?>/img/integral/<?= $img_url ?>"
                                style="width: 20px"></a>
                </p><br>
                <p>分类：</p>
                ...
                <p>评论：</p>
                <span><a href="#project_comment" class="" onclick="comments()"><?= get_comments_number()?>条</a></span><br>
            </div>
            <br>
            ...
            <div class="related_wikis">
                ...
                <div class="related_wiki" id="related_wiki">
                    <ul style="padding-left: 0px; ">
                        <?php
                        //控制条数
                        if (sizeof($related_wiki) < 5) {
                            $length = sizeof($related_wiki);
                        } else {
                            $length = 5;
                        }
                        for ($i = 0; $i < $length; $i++) { ?>
                            <li class="list-group-item">
                                <a href="<?php echo get_permalink($related_wiki[$i]["wiki_id"]); ?>"
                ...
                <div class="more_related_wiki" id="more_related_wiki" style="display: none">
                    <ul style="padding-left: 0px">
                        ...
                        for ($i = 0; $i < $length; $i++) { ?>
                            <li class="list-group-item">
                                <a href="<?php echo get_permalink($related_wiki[$i]["wiki_id"]); ?>"
                                   class="question-title" id="more_wiki">
                                    <?php echo get_the_title($related_wiki[$i]["wiki_id"]); ?>
                                </a>
                            </li>
                        <?php } ?>
...
<div class="side-tool" id="side-tool-project">
    <ul>
        ...
        <?php if (is_user_logged_in()) { ?>
            ...
            <li data-placement="left" data-toggle="tooltip" data-original-title="经验分享"><a onclick="addLayer2()"
                                                                                          id="ask_link">分享</a></li>
        <?php } else { ?>
            <li data-placement="left" data-toggle="tooltip" data-original-title="不懂就问">
                <a href="<?php echo wp_login_url(get_permalink()); ?>">提问</a>
            </li>
            <li data-placement="left" data-toggle="tooltip" data-original-title="经验分享"><a
                        href="<?php echo wp_login_url(get_permalink()); ?>">分享</a></li>
        <?php } ?>
