...
function curl_post_https(){ // 模拟提交数据函数
    $data = [
        ...
        'usersno'=>isset($_POST["usersno"]) ? $_POST["usersno"] : '',
        ...
        'othercontent'=>isset($_POST["othercontent"]) ? $_POST["othercontent"] : '',
    ];
    $curl = curl_init(); // 启动一个CURL会话
    curl_setopt($curl, CURLOPT_URL, 'https://www.attentions.org/index.php/api/opendata/data'); // 要访问的地址
