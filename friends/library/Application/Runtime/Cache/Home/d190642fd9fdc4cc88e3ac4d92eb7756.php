                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['username'] == $to['username']): ?><tr>
                            ...
                            <td align="center">
                                <a class="link-update" style="cursor:pointer;" data-number="<?php echo ($vo["nownumber"]); ?>" data-role="<?php echo ($vo["name"]); ?>" data-name="<?php echo ($vo['username']); ?>">回收</a><br /> 
                            </td>
