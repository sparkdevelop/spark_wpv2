...
<div class="main">
    <div class="main-m">
        ...
        <div>
            <form class="form" name="form"  action="<?php echo U(bookinfoLogin_user,array('book_id'=>$book_id));?>" method="post" onsubmit="return check()">
                ...
                <div class="main-bottom">
                    ...
                    <a class="register" href="<?php echo U(bookinfoRegister,array('book_id'=>$book_id));?>">立即注册</a>
                </div>
            </form>
        </div>
    </div>
