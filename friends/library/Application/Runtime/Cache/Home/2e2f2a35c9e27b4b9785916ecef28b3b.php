...
<div class="result-wrap">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td  class="td-img" align="center"><img style="height:160px;width:160px;" src="<?php echo ($vo["img"]); ?>"></td>
                            ...
                            <td  align="center"><?php echo ($vo["nownumber"]); ?></td>
                             <td  align="center">
                                <div class="divScroll">
                                    ...
                                    <?php if($go['status'] == 4 ): echo ($go["time"]); ?>(报修<?php echo ($go["number"]); ?>) <br /><?php endif; endif; endforeach; endif; else: echo "" ;endif; ?> 
                                </div>
                            </td>
                            <td align="center">
                                <a class="reback-link" href="#rebackmodal" data-number="<?php echo ($vo["nownumber"]); ?>" data-name="<?php echo ($vo["name"]); ?>" >借用</a><br />
                            </td>
        ...
        <div id="rebackmodal" class="tan-reback" style="display:none;">
          <div>借用&nbsp;<strong id="rebackNumStr" style="font-size:24px;"></strong>&nbsp;的数量</div><br/><br/>
          <label for="username">数量:</label>
          <input type="text" id="rebackNum"><br/><br/><br/>
          <a id="rebackNumAck" href="#">确认</a>&nbsp;&nbsp;&nbsp;
