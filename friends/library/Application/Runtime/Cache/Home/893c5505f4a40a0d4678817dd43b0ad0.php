    ...
    <div class="main">
        ...
        <div class="main-left">
            <div class="main-left-person">
                <div class="main-img">
                    <img src="/passon/Public/images/basketball.jpg"/><br/>
                ...
                <div class="main-ul">
                    ...
                    <?php if ($flag == 1): ?>
                        <div class="main-a">
                            <a href="<?php echo U(groupcontribute,array('groupid'=>$groupid));?>">
                                <input class="sharebtn1" type="button" value="我要分享"/>
                            </a>
                        </div>
                    <?php elseif ($flag ==0): ?>
                        <div class="main-a">
                            <!--<a href="<?php echo U(groupJoin,array('groupid'=>$groupid));?>">-->
                            <input class="sharebtn2" type="button" value="加入群组"/>
                            <input style="display: none" type="button" value="<?php echo ($groupid); ?>"/>
                            <!--</a>-->
                        </div>
                    <?php endif ?>
...
<script type="text/javascript" src="/passon/Public/js/addgroup.js"></script>
