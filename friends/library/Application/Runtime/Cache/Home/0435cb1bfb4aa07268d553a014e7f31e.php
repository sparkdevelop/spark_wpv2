    ...
    <div class="main">
        <div class="main-form">
            ...
            <form class="form-body" action="<?php echo U(pbookrenew);?>" method="post">
                ...
                <input id="time2" class="div-width" name="time" type="radio" value="7"/><label for="time2">一个星期</label><br/>
                <input id="time3" class="div-width" name="time" type="radio" value="14"/><label for="time3">两个星期</label><br/>
                <input id="time4" class="div-width" name="time" type="radio" value="30"/><label for="time4">一个月</label><br/>
