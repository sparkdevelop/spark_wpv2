    ...
    <div class="main">
        ...
        <div class="main-left">
            <div class="main-left-person">
                <div class="main-img">
                    <?php if($userguest['image'] == ''):?>
                    <img class="user-images" src="/passon/Public/images/defaultheader.jpg"/><br/>
                    <?php else :?>
                    <img class="user-images" src="<?php echo ($userguest['image']); ?>"/><br/>
                    <?php endif?>
                    <span class="username"><?php echo ($userguest['username']); ?></span><br/>
                    <?php if($friengflag == 0) :?>
                    <input class="add-attention" type="button" value="加关注"/>
                    <span class="username" style="display: none"><?php echo ($userguest['username']); ?></span>
                    <?php else:?>
                    <input class="add-attention" style="background-color: #5e99b3" type="button" value="已关注"/>
                    <?php endif?>
                </div>
                <div class="username-details">
                    ...
                    <img src="/passon/Public/images/flower.png"/><img src="/passon/Public/images/flower.png"/><img src="/passon/Public/images/flower.png"/>
                    <?php endif?>
                    <div><?php echo ($userguest['describe']); ?></div>
                                ...
                                <?php if(is_array($booknote)): foreach($booknote as $key=>$item): ?><li>
                                        ...
                                        <div class="comment-comment-ul">
                                            <ul>
                                                ...
                                                <?php endforeach ?>
                                                <form name="form" action="<?php echo U(doGuestbooknote_note);?>" method="post" onsubmit="return check1()">
