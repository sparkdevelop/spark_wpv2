        ...
        <div class="main-left">
            <div class="main-left-person">
                ...
                <div class="username-details">
                    ...
                    <div><?php echo ($user['subscribe']); ?></div>
                ...
                <div class="main-ul">
                    <ul>
                        ...
                        <li><?php echo ($friendcount); ?><br/><br/>粉丝</li>
                    </ul>
            ...
            <div class="subnavigate" style="display: block">
                ...
                <div style="display: none;">
                    ...
                    <div class="mybook" >
                        <div class="submybook" style="display:block;">
                            <div>共<?php echo ($personalcount); ?>本/仅自己可见</div>
                    ...
                    <div class="submybook" style="display: none;">
                        ...
                        <?php else: ?>
                        <div>漂流中-共<?php echo ($countSharecan); ?>本/他人可借阅</div>
                        <ul>
                ...
                <div class="booktags" style="display: none">
                    <div class="bookmessage-nav">
                        <ul class="bookmessage">
                            ...
                            <li><a href="<?php echo U(bookalready);?>">已读</a></li>
                        </ul>
                        <div class="main-a"><a href="<?php echo U(contribute);?>"><input class="sharebtn" type="button" value="书籍上传"/></a></div>
                    </div>
                    <div class="mybook" >
                        <div class="submybook" style="display: block">
                            <?php if($resultreading == 0): ?>
                            <div class="submybook-first">
                                <img src="/passon/Public/images/false.png"/>
                                <div>没有在读书籍？</div>
                            ...
                            <?php else :?>
                            <div>共<?php echo ($resultreading); ?>本</div>
                            <ul>
                        ...
                        <div class="submybook" style="display: none">
                            ...
                            <?php else :?>
                            <div>共<?php echo ($wantcount); ?>本</div>
                            <ul>
                ...
                <div class="submybook" style="display: block;">
                    <div class="focus-container">
                        ...
                        <?php else:?>
                        <div class="focus-hd">
                            <p class="strong"><span>用户名</span>关注了<?php echo ($friendcount); ?>人</p>
                        </div>
                        <div class="focus-bd">
                            <?php if(is_array($friendlist)): foreach($friendlist as $key=>$item): ?><div class="avatar-message clearfix">
                                    ...
                                    <div class="message">
                                        ...
                                        <p><span><?php echo ($item['sharecount']); ?></span>共享书籍/<span><?php echo ($item['notecount']); ?></span>笔记/<span><?php echo ($item['friendcount']); ?></span>粉丝/帮助过<span>0</span>人 </p>
                                    </div>
                                    <div class="btn">
                        ...
                        <div class="focus-ft">
                            <div class="crumb">
                                <p class="strong"><span>用户名</span>关注了3人</p>
                            </div>
                            <div class="avatar-message clearfix">
                                <div class="avatar">
                                    <img src="" alt="">
                                </div>
                                <div class="message">
                                    <p class="name">用户名</p>
                                    <p class="description">个人描述</p>
                                    <p><span>0</span>共享书籍/<span>0</span>笔记/<span>0</span>粉丝/帮助过<span>0</span>人 </p>
                                </div>
                                <div class="btn">
                                    <input class="add-btn" value="关注"/>
                                </div>
                            </div>
                        </div>
                        <?php endif?>
