...
<head>
    ...
    <title>个人中心</title>
    <link rel="stylesheet" type="text/css" href="/makerway/Public/css/person.css">
...
<body>
    ...
    <div class="title">
        ...
        <div class="main">
            <div class="classify">
                <div class="classify-title"><a style="cursor: pointer;color:#000;text-decoration: none" href="<?php echo U(index);?>">MakerWay</a>>我的主页</div>
            </div>
            <div class="main-left">
                <div class="main-left-person">
                    <div class="main-img">
                        <?php if($user['image'] == ''):?>
                        <img class="user-images" src="/makerway/Public/images/defaultheader.jpg"/><br/>
                        <?php else :?>
                    ...
                    <div class="username-details">
                        <?php if($honer < 50) :?>
                        <img src="/makerway/Public/images/flower.png"/>
                        <?php elseif($honer>49 && $honer<150):?>
                        <img src="/makerway/Public/images/flower.png"/><img src="/makerway/Public/images/flower.png"/>
                        <?php elseif($honer>149 && $honer<250):?>
                        <img src="/makerway/Public/images/flower.png"/><img src="/makerway/Public/images/flower.png"/><img src="/makerway/Public/images/flower.png"/>
                        <?php elseif($honer>249 && $honer<500):?>
                        <img src="/makerway/Public/images/tree.png"/>
                        <?php elseif($honer>549 && $honer<1000):?>
                        <img src="/makerway/Public/images/tree.png"/><img src="/makerway/Public/images/tree.png"/>
                        <?php elseif($honer>999 && $honer<2000):?>
                        <img src="/makerway/Public/images/tree.png"/><img src="/makerway/Public/images/tree.png"/><img src="/makerway/Public/images/tree.png"/>
                        <?php elseif($honer>1999 && $honer<5000):?>
                        <img src="/makerway/Public/images/apple.png"/>
                        <?php elseif($honer>4999 && $honer<10000):?>
                        <img src="/makerway/Public/images/apple.png"/><img src="/makerway/Public/images/apple.png"/>
                        <?php else :?>
                        <img src="/makerway/Public/images/flower.png"/><img src="/makerway/Public/images/flower.png"/><img src="/makerway/Public/images/flower.png"/>
                        <?php endif?>
            ...
            <div class="main-right">
                <div class="navigate">
                    <ul>
                        <li>动态</li>
                        <li  class="border">我的书房</li>
                        <li><a href="<?php echo U(bookreading);?>">阅读情况</a></li>
                ...
                <div class="subnavigate">
                    ...
                    <div  style="display:block;">
                        <div class="bookmessage-nav">
                            <ul class="bookmessage">
                                <li><a href="<?php echo U(mypersonal);?>">私人书籍</a></li>
                            ...
                            <div class="submybook" style="display: none;">
                                ...
                                <div class="submybook">
                                    <div class="submybook-first">
                                        <img src="/makerway/Public/images/false.png"/>
                                        <div>没有私人书籍？</div>
                                        <div>快来上传书籍吧！</div>
                                    </div>
                                </div>
                                ...
                                <ul>
                                    <?php if(is_array($personalbooklist)): foreach($personalbooklist as $key=>$item): ?><li>
                                            ...
                                            <div class="select-nav">
                                                <img src="/makerway/Public/images/select.png"/>
                                                <ul>
                                                    <!--<li>删除</li>-->
                                                    <li>共享</li>
                    ...
                    <div class="booktags" style="display: none">
                        <div class="bookmessage-nav">
                            <ul class="bookmessage">
                                <li class="activecolor"><a href="<?php echo U(bookreading);?>">在读</a></li>
                                <li><a href="<?php echo U(bookwant);?>">想读</a></li>
                                <li>已读</li>
                            </ul>
                            <div class="main-a"><a href="<?php echo U(contribute);?>"><input class="sharebtn" type="button" value="书籍上传"/></a></div>
                        </div>
                        ...
                        <div class="focus-container">
                            ...
                            <div class="focus-bd">
                                <div class="default clearfix">
                                    <div class="avatar">
                                        <img src="/makerway/Public/images/avatar.jpg" alt="">
                                    </div>
                                    <div class="text">
                                        浩瀚书海，我还没有好友相伴？<br>
...
<script type="text/javascript" src="/makerway/Public/js/person.js"></script>
