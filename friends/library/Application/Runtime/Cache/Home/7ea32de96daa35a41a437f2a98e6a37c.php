...
<div class="content">
    ...
    <div class="main">
        <div class="classify">
            <div class="classify-title"><a style="cursor: pointer;color:#000;text-decoration: none" href="<?php echo U(index);?>">MakerWay</a>><?php echo $guestname?>的个人中心</div>
        </div>
        <div class="main-left">
            <div class="main-left-person">
                ...
                <div class="main-ul">
                    ...
                    <div class="main-a"><a><input class="sharebtn" type="button" value="加为好友"/></a></div>
                </div>
            </div>
        </div>
        <div class="main-right">
            <div class="navigate">
                <ul>
                    <li class="border">Makerway</li>
                    <li><a href="<?php echo U(guestPersonshare);?>">书架</a></li>
                    <li>笔记</li>
                    <li>群组</li>
                    <li>好友</li>
                </ul>
            ...
            <div class="subnavigate">
                ...
                <div style="display: none;">
                    <ul class="bookmessage">
                        ...
                        <li><a href="<?php echo U(myKeeps);?>">借阅信息</a></li>
                        <li>关注</li>
                    </ul>
