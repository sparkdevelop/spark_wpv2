...
<div class="main">
    <div class="main-m">
        ...
        <div>
            <form class="form" name="form"  action="<?php echo U(commentLogin_user,array('book_id'=>$book_id));?>" method="post" onsubmit="return check()">
                ...
                <div class="main-bottom">
                    ...
                    <a class="register" href="<?php echo U(commentRegister,array('book_id'=>$book_id));?>">免费注册</a>
                </div>
            </form>
        </div>
    </div>
