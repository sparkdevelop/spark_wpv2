    ...
    <div class="main">
        ...
        <div class="main-right">
            <div class="navigate">
                <ul>
                    <li>Makerway</li>
                    <li class="border"><a href="<?php echo U(guestPersonshare);?>">书架</a></li>
                    <li>笔记</li>
                    <li>群组</li>
                    <li>好友</li>
                </ul>
            ...
            <div class="subnavigate">
                ...
                <div style="display:block;">
                    <ul class="bookmessage">
                        ...
                        <li><a href="<?php echo U(guestKeeps);?>">借阅信息</a></li>
                        <li class="activecolor">关注</li>
                    </ul>
                    <div class="mybook" >
                                ...
                                <?php if(is_array($mybooks)): foreach($mybooks as $key=>$item): ?><li>
                                        <div class="main-body-li">
                                            <div onclick="document.location='<?php echo U(bookInfo,array('bookid'=>$item['book_id']));?>'" style="cursor:pointer">
                                                ...
                                                <span class="comment">书本状态：<?php if($item['status']==1) echo '可借阅'; if($item['status']==2) echo '已借出';if($item['status']==3) echo '可借阅'?></span>
                                            </div>
                        ...
                        <div class="submybook" style="display: none;">
                            <ul class="dosomething">
                                ...
                                <li style="cursor: pointer"><a href="<?php echo U(guestBookkeeps);?>">保管中</a></li>
                            </ul>
                            <div class="doing">
                                <div style="display: block;">
                                    <ul>
                                        ...
                                        <div class="my-group">
                                            ...
                                            <ul>
                                                <li onclick="document.location='<?php echo U(groupcheck,array('groupid'=>$groupmessage['id']));?>'">
                                                    ...
                                                    <span class="group-menber">该群好友：<span>XYZ</span></span>
                                                </li>
                                            </ul>
                                        </div>
                                        <?php endif ?>
...
<script type="text/javascript" src="/passon/Public/js/addfriend.js"></script>
