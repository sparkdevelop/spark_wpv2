                    ...
                    <div class="second-navigate">
                        <div class="second-message" style="display: block;">
                            <form class="messageform">
                                <div class="label-m"><label class="label-left" for="lab-name">群组名字：</label><input id="lab-name" class="lab-name"/></div><br/>
                                ...
                                <div class="label-m"><label class="label-left" for="lab-summary">群组简介：<br>(<100字)</label>
                                    <textarea id="lab-summary" class="lab-summary"></textarea>
                                </div><br/>
                                <!--<div class="span-s">分类：-->
