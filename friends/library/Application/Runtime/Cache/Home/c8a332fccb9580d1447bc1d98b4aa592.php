...
<head>
    ...
    <script type="text/javascript" src="/library/Public/js/jquery-1.11.1.min.js">
    </script>    
    <script type="text/javascript" src="/library/Public/js/mine.js">
    </script>
</head>
<body>
<div class="content">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <th></th> 
                            <th>共<?php echo ($sumcom); ?>种</th> 
                            <th></th> 
                            <th><?php echo ($sumnum); ?>个</th> 
                            <th><?php echo ($sumleft); ?>个</th>
                            <th><?php if($sumborrow != 0): echo ($sumborrow); ?>个<?php endif; ?>
                            </th>
                            <th><?php if($sumkeep != 0): echo ($sumkeep); ?>个<?php endif; ?>
                            </th>
                            <th><?php if($sumrepair != 0): echo ($sumrepair); ?>个<?php endif; ?>
                            </th>
                        </tr>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <!-- 饼状图 -->
                            <!-- <td align="center">饼状图</td>  -->
                            <td align="center"><?php echo ($vo["number_left"]); ?></td>
                            
                            <td align="center">
                            <?php if(is_array($arrb)): $i = 0; $__LIST__ = $arrb;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$qo): $mod = ($i % 2 );++$i; if($qo['name'] == $vo['name']): echo ($qo["nownumber"]); endif; endforeach; endif; else: echo "" ;endif; ?>
                            </td>

                            <td align="center">
                            <?php if(is_array($arrk)): $i = 0; $__LIST__ = $arrk;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wo): $mod = ($i % 2 );++$i; if($wo['name'] == $vo['name']): echo ($wo["nownumber"]); endif; endforeach; endif; else: echo "" ;endif; ?>
                            </td>

                            <td align="center">
                            <?php if(is_array($arrr)): $i = 0; $__LIST__ = $arrr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$eo): $mod = ($i % 2 );++$i; if($eo['name'] == $vo['name']): echo ($eo["nownumber"]); endif; endforeach; endif; else: echo "" ;endif; ?>
                            </td>
                            
                        </tr>
                       <!--  <hr/>为什么分割线显示不正常？ --><?php endforeach; endif; else: echo "" ;endif; ?>
