...
<div class="content">
    ...
    <div class="main">
        ...
        <div class="main-body">
            ...
            <div class="conname">
                <form action="<?php echo U(dogroupContribute,array('groupid'=>$groupid));?>" method="post">
                    <input name="submit" type="submit" value="确认分享" />
                    <input class="current" type='button' onclick="document.location='<?php echo U(groupcontribute,array('groupid'=>$groupid));?>'" value="返回重填"/><br/><br/>
