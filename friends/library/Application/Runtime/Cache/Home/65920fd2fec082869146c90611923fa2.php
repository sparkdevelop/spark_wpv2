...
<div class="main">
    <div class="main-m">
        ...
        <div>
            <form class="form" name="form"  action="<?php echo U(commentMysqlUser,array('book_id'=>$book_id));?>" method="post" onsubmit="return check()">
                ...
                <div class="main-bottom">
                    ...
                    <a class="register" href="<?php echo U(commentLogin,array('book_id'=>$book_id));?>">登录</a>
                </div>
            </form>
        </div>
    </div>
