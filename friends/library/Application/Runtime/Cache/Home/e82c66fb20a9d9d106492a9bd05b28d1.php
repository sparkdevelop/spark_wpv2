...
<div class="content">
    ...
    <div class="main">
        <div class="classify">
            <div class="classify-title"><a style="cursor: pointer;color:#000;text-decoration: none" href="<?php echo U(index);?>">MakerWay</a>><?php echo ($userguest['username']); ?>的主页</div>
        </div>
        <div class="main-left">
            <div class="main-left-person">
                <div class="main-img">
                    <img class="user-images" src="<?php echo ($userguest['image']); ?>"/><br/>
                    <span class="username"><?php echo ($userguest['username']); ?></span>
                </div>
                <div class="username-details">
                    <img src="/passon/Public/images/flower.png"/>
                    <div><?php echo ($userguest['subscribe']); ?></div>
        ...
        <div class="main-right">
            <div class="navigate">
                <ul>
                    ...
                    <li>我的书房</li>
                    <li>阅读情况</li>
                    <li><a href="<?php echo U(guestBooknote);?>">我的笔记</a></li>
                    <li>关注</li>
                </ul>
            </div>
